...
const Page4 = () => {
  ...
  <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-12">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:w-1/2">
      <div className="flex flex-col items-center px-6 py-2 border border-gray-400 hover:bg-gray-700 text-sm tracking-widest uppercase text-center">
      ...
      <div className="flex flex-col items-center px-6 py-7 border border-gray-400 hover:bg-gray-700 text-sm tracking-widest text-center">
        <div className="text-4xl mb-4">
